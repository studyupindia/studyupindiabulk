/**
 * Buyer Login JavaScript
 * This file contains specific functionality for the buyer login page.
 */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", handleBuyerLogin);
  }
...
function handleBuyerLogin(event) {
  ...
  fetch("/buyer/signin", {
    ...
    .then((data) => {
      ...
      // storageMethod.setItem("user_id", data.buyer.id);
      // storageMethod.setItem("user_name", data.buyer.name);
      // storageMethod.setItem("user_email", data.buyer.email);
      // storageMethod.setItem("user_role", "buyer");
